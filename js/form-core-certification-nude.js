...
/* ---------- 유입 URL 파라미터 (매체 × 지역 × 연령) ---------- */
  ...
  if (phoneWrapEl) {
    ...
    otpBox.innerHTML =
      '<p style="font-size:14px;color:#d33;margin-bottom:4px; text-align:left;">타인 번호 도용방지를 위해 번호 인증을 시행하고 있습니다.</p>' + // 번호인증 카피 ) 타인 번호 도용 방지를 위해 번호인증을 시행하고 있습니다. / 정확한 탕감액 산정을 위해 번호 인증을 진행해주세요.
      '<div class="otp-row">' +
